...
- [examples/hopper-escrow](https://github.com/BluefootLabs/Hopper-Solana-Zero-copy-State-Framework/tree/main/examples/hopper-escrow): funded classic SPL Token escrow with atomic exchange, maker cancellation, surplus refunds, and rent recovery. Layout v2 replaces the old state-only sketch.
