...
- Under pina's cross-framework fixtures, rebuilt with pina's recipe and a verifier that reproduces pina's published pinocchio numbers exactly (2026-09-21), the Hopper substrate hello world is 1,656 bytes at 116 CU, the smallest binary in that table, and the Hopper macro counter initializes in 3,207 CU against Pina 3,301, Anchor v2 3,458, and Quasar 3,488, and increments in 1,748 against Pina 1,753 and Anchor 2,117. The like-for-like substrate counter is 8,448 bytes to pinocchio's 6,512, and the macro hello costs 186 CU; both gaps are recorded with their measured breakdown, not hidden. See [bench/framework-comparison](https://github.com/BluefootLabs/Hopper-Solana-Zero-copy-State-Framework/tree/main/bench/framework-comparison).
