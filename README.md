...
state receipts, and cross-program interfaces. All `no_std`, all `no_alloc`,
no proc macros.
...
- **Frame** - Phased execution model (Resolve -> Validate -> Execute) enforced at compile time via typestate
