...
5. **[hopper-compact-vault](hopper-compact-vault/README.md)** - Deployable
   1-byte compact account proof. Shows the exact 41-byte `[disc][body]` layout,
...
7. **[hopper-proc-vault](hopper-proc-vault/src/lib.rs)** - Proc-macro vault that
   demonstrates the `#[hopper::account]` / `#[hopper::program]` authoring path.

8. **[hopper-treasury](hopper-treasury/src/lib.rs)** - Multi-segment treasury
   with permissions and budget controls.

9. **[hopper-registry](hopper-registry/src/lib.rs)** - Segmented account with
   journal, virtual state, and named segment lookup.

10. **[hopper-migration](hopper-migration/src/lib.rs)** - V1 to V2 layout
...
11. **[hopper-virtual-state](hopper-virtual-state/src/lib.rs)** - Multi-account
   entities with VirtualState and ShardedAccess. For when your state is too big
   for one account.

12. **[cross-program-read](cross-program-read/)** - Two separate programs reading
...
13. **[hopper-policy-vault](hopper-policy-vault/src/lib.rs)** - Three sibling
...
14. **[hopper-showcase](hopper-showcase/src/lib.rs)** - Full systems-mode tour.
...
15. **[hopper-devnet-audit](hopper-devnet-audit/src/lib.rs)** - Deployable
...
16. **[hopper-external-oracle](hopper-external-oracle/src/lib.rs)** - Known
