//! Minimal, dependency-free SHA-256 for Grillo's mutation-contract
//! commitment hash.
//!
...
mod tests {
    ...
    #[test]
    fn two_block_vector() {
        // FIPS 180-2 second example: a 56-byte message that spans a padding
        // boundary and forces a second compression block.
    ...
    #[test]
    fn long_repeated_message_spans_many_blocks() {
        // SHA-256 of one million 'a' bytes (FIPS 180-2 example 3).
    ...
    #[test]
    fn one_bit_change_changes_the_whole_digest() {
        // Avalanche sanity: a single differing byte yields a fully
        // different digest (the property the commitment relies on).
        assert_ne!(sha256(b"grillo"), sha256(b"grilln"));
    }
}
