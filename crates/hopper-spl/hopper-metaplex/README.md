...
[![Docs.rs](https://img.shields.io/docsrs/hopper-metaplex)](https://docs.rs/crate/hopper-metaplex/0.2.1)
...
```toml
[dependencies]
hopper = { package = "hopper-lang", version = "0.2.1", features = ["metaplex"] }
```
