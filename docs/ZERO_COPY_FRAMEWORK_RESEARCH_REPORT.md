...
**Note on Star Frame**: Confirmed **non-existent** — zero GitHub search results, 404 on crates.io, 404 on `buffalojoec/starframe`. The user may have confused this with another project. This report covers the 6 real frameworks.
