...
_hopper() {
    ...
    commands=(
        ...
        'fetch:pull application-provisioned legacy manifest PDA'
        ...
        'mobile:generate mobile binding stubs'
...
complete -c hopper -n '__fish_use_subcommand' -a 'fetch' -d 'pull application-provisioned legacy manifest PDA'
...
complete -c hopper -n '__fish_use_subcommand' -a 'mobile' -d 'generate mobile binding stubs'
